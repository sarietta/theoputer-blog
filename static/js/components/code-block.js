...
let CodeBlock = class CodeBlock extends i {
    static styles = i$3 `
  pre {
    overflow-x: auto;
    font-size: 0.875em;
  ...
  `;
    ...
    render() {
        const tabs = this.originalChildren.map((e) => (e.firstChild?.firstChild).dataset['lang']);
        return x `<div>
        <div class="tabs">
            ${tabs.map((tab, index) => x `
...
__decorate([
    r()
], CodeBlock.prototype, "selected", void 0);
__decorate([
    r()
], CodeBlock.prototype, "originalChildren", void 0);
